...
class PartyTest {
    ...
    @Test
    fun `celebrityInvitedQuadratic should return celebrity when one exists`() {
        // given:
        val socialNetwork = arrayOf(
            booleanArrayOf(false, true, true),  // Person 0 knows Person 1 and 2
            booleanArrayOf(false, false, true), // Person 1 knows Person 2
        ...
        // when:
        val celebrity = party.findCelebrityQuadratic()
    ...
    @Test
    fun `celebrityInvitedQuadratic should return null when no celebrity exists`() {
        // given:
        val socialNetwork = arrayOf(
            booleanArrayOf(false, true, true),  // Person 0 knows Person 1 and 2
            booleanArrayOf(true, false, true),  // Person 1 knows Person 0 and 2
    ...
    @Test
    fun `celebrityInvitedQuadratic should handle single person case`() {
        // given:
        val socialNetwork = arrayOf(
            booleanArrayOf(false)  // Single person doesn't know themselves
        )
    ...
    @Test
    fun `celebrityInvitedQuadratic should handle edge case where everyone knows everyone`() {
        // given:
        val socialNetwork = arrayOf(
            booleanArrayOf(false, true, true),  // Person 0 knows Person 1 and 2
            booleanArrayOf(true, false, true),  // Person 1 knows Person 0 and 2
    ...
    @Test
    fun `celebrityInvitedQuadratic should handle edge case where nobody knows anyone`() {
        // given:
        val socialNetwork = arrayOf(
            booleanArrayOf(false, false, false),  // Person 0 knows nobody
            booleanArrayOf(false, false, false),  // Person 1 knows nobody
